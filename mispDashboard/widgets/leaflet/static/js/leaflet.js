class leaflet_widget {
    constructor(container, options) {
        ...
        this.data_source;
        this.mapEventManager = new MapEventManager(this.myOpenStreetMap);
            ...
            $.when(
                ...
                function() { // success
                    ...
                    that.preData.forEach(function(j) {
                        ...
                        var mapEvent = new MapEvent(j, marker);
        ...
        /*
        TESTING EventSource
            -> Connect to redis_server_map
            -> Send some data
            -> See the map being populated (hopefully)
...
class MapEventManager {
    ...
    addMapEvent(mapevent, doNotRotate) {
